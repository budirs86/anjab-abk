...
@section('container')
    ...
    <div class="card-head mb-3">
        <h1 class="fw-light fs-4 d-inline nav-item">Edit Analisis Beban Kerja {{ $ajuan->tahun }} {{ $unit_kerja->nama }}</h1>                
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-between">
                            <p>{{ $jabatan->nama }}</p>
                            <div class="">
                                <a href="{{ route('abk.jabatan.edit',[$ajuan, $unit_kerja, $jabatan]) }}" class="btn btn-sm btn-warning ms-auto"><img width="20px" data-feather="edit"></img>Edit Analisis Beban Kerja</a>
                            </div>
                        </div>
                    </td>
                </tr>
