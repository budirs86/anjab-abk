...
<div class="" id="kualifikasi">
    ...
    <table class="table 
                table-bordered w-75">
        <caption class="caption-top text-black">Kualifikasi Jabatan | Pengalaman</caption>
        <thead class="table-primary">
            <th>No</th>
    ...
    <table class="table 
                table-bordered w-75">
        <caption class="caption-top text-black"> Kualifikasi Jabatan | Pelatihan</caption>
        <thead class="table-primary">
            <th>No</th>
...
<div class="" id="syarat_jabatan">
        ...
        @foreach ($minat_kerjas as $minat_kerja)
            <div class="col-4">
                <div class="form-check">
                    ...
                    <label class="form-check-label"
                        for="{{ $minat_kerja->nama }}">{{ $minat_kerja->nama }}</label>
                </div>
            </div>
        @endforeach
    </div>
    ...
    <div class="row mb-4" id="fungsi_pekerjaan">
        ...
        <div class="col-4">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="{{   $fungsi_pekerjaan->id }}" id="{{ $fungsi_pekerjaan->nama }}" name="{{ $fungsi_pekerjaan->nama }}">
...
<div class="d-flex justify-content-end">
    <a href="{{ route('anjab.ajuan.create') }}" class="btn header1 btn-primary"><i data-feather="save"></i> Simpan dan Kembali</a>
</div>
