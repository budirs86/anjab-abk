                    ...
                    <td class="w-25">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="/anjab/ajuan/{{ $i }}?periode={{ $i + 2020 }}"
                                    class="btn btn-outline-primary">Lihat</a>
                                @if ($i % 2 != 0)
                                @else
                                    <a href="/abk/ajuan/create" class="btn btn-outline-success" aria-disabled="true">Buat
                                        Ajuan ABK</a>
                                @endif
                            </div>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-between">
                            <p>{{ $ajuan->tahun }}</p>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="/anjab/ajuan/{{ $ajuan->id }}" class="btn btn-outline-primary">Lihat</a>
                                <a href="/abk/ajuan/create" class="btn btn-outline-success" aria-disabled="true">Buat Ajuan
                                    ABK</a>
                            </div>
                        </div>
                    </td>
